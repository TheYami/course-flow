...
export default function Feature() {
  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center p-3 mt-10 gap-20 w-full md:w-[768px] lg:w-[1024px]  lg:my-20 relative xl:w-[1440px] xl:h-[780px] xl:mb-12 xl:mt-24 2xl:ml-[240px] 2xl:h-[1111px] 2xl:my-0">
        {/* First Feature Block */}
