...
export default function Navbar() {
  ...
  const handleClickOutside = (event) => {
    if (menuRef.current && !menuRef.current.contains(event.target) && svgRef.current && !svgRef.current.contains(event.target)) {
      setBoxMenu(false);
    }
  };
            ...
            <li>
              <div className="flex gap-3 items-center relative">
                  ...
                  <svg width="12" height="8" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg" 
                    className="cursor-pointer" onClick={toggleMenu} ref={svgRef}>
              ...
              {boxMenu && (
                <div ref={menuRef} className="rounded-lg absolute top-16 left-[-106px] lg:top-12 md:left-[-95px] lg:left-[45px] z-50 pt-2 bg-white w-[198px] shadow-lg">
                  ...
                  <div className="border-t border-[#E4E6ED] cursor-pointer px-2 hover:bg-gray-300 rounded-md" onClick={handleLogout}>
