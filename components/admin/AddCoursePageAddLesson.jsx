        ...
        <div className="bg-[#FFFFFF] mx-10 my-10 rounded-[16px] px-[100px] pt-[40px] pb-[60px] flex flex-col gap-[40px]">
          <section className="lesson-name">
            <div className="relative">
              ...
              />
              <div className="absolute right-3 top-2/3 transform -translate-y-1/2 text-[#9B2FAC]">
                      ...
                      {!subLesson.videoPreview ? (
                        <>
                          ...
                          >
                            ...
                            />
                            {videoUploadError && (
                              <p className="absolute bottom-5 left-20 text-[#9B2FAC] text-sm mt-1">
                                Upload failed. Ensure the file is .mp4, .mov,
                                .avi and less than 20 MB.
                              </p>
                            )}
