...
export default function Review() {
  const settings = {
    ...
    centerPadding: "550px", // ระยะ padding ซ้าย-ขวา
    dots: false,
    infinite: true,
    speed: 500,
    ...
    responsive: [
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "400px", // ลด Padding อีก
          centerMode: true,
        },
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "300px", // ลด Padding อีก
          centerMode: true,
        },
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "120px", // ลด Padding อีก
          centerMode: true,
        },
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "250px", // ลด Padding เมื่อหน้าจอแคบลง
          centerMode: true,
        },
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "40px", // ลด Padding เมื่อหน้าจอแคบลง
          centerMode: true,
        },
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          centerPadding: "15px", // ลด Padding เมื่อหน้าจอแคบลง
          centerMode: true,
        },
      },
    ],
  ...
  return (
    <>
      ...
      <div className="slider-container mx-0 w-full px-0 mb-0 h-[660px] lg:h-[500px]">
        <Slider {...settings}>
          {cards.map((card) => (
            <div key={card.id} className="p-2 relative mt-5 lg:p-0 md:left-40">
