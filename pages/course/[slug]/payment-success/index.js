  ...
  return (
    <>
      ...
      <div className='relative md:flex md:justify-center p-4'>
        <Link href={`/course/${slug}`} className="md:hidden flex gap-2 no-underline text-[#2F5FAC] font-bold hover:text-blue-500 w-20 px-2 py-1 items-center">
